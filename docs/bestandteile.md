...
SingleServer mit Floating-IP
Wir checken uns das öffentliche Github-Repo auf unserem Toolbox-Host aus

Praktische Beispiele B)
Servergruppen

Praktische Beispiele C)
Cloud-Init kennen lernen

Praktisches Beispiel C)
ein reales Beispiel mit verteilt laufender Anwendung, Datenbankanbindung 
und persistenten Sessions.